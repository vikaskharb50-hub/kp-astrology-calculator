...
export class Backend implements backendInterface {
    ...
    async loadChart(): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.loadChart();
    ...
    async saveChart(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveChart(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
